 ...
 function updateAchievements() {
   ...
   return (
       <div>
           ...
           <ul>
               {/* Achievements Box */}
            <div style={{ padding: "10px", border: "2px solid black", backgroundColor: "#f9f9f9", borderRadius: "10px", marginTop: "10px", textAlign: "center", width: "300px" }}>
                <h3>🏅 Achievements</h3>
                <ul>
           ...
           {challenge && (
               <div style={{ padding: "10px", border: "2px solid gold", backgroundColor: "#fffae6", borderRadius: "10px", marginTop: "10px" }}>
           ...
           {/* Streak Tracker UI */}
           <div style={{ padding: "10px", border: "2px solid blue", backgroundColor: "#e6f7ff", borderRadius: "10px", marginTop: "10px" }}>
